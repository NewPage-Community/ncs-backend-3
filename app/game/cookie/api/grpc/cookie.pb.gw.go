...
var (
	pattern_Cookie_GetCookie_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"game", "cookie", "get", "uid", "key"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Cookie_GetAllCookie_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"game", "cookie", "all", "uid"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Cookie_SetCookie_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"game", "cookie", "set"}, "", runtime.AssumeColonVerbOpt(true)))
)
