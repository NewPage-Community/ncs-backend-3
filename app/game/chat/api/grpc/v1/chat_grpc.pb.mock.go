...
// Source: app/game/chat/api/grpc/v1/chat_grpc.pb.go
...
// mustEmbedUnimplementedChatServer mocks base method.
func (m *MockChatServer) mustEmbedUnimplementedChatServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedChatServer")
}

// mustEmbedUnimplementedChatServer indicates an expected call of mustEmbedUnimplementedChatServer.
func (mr *MockChatServerMockRecorder) mustEmbedUnimplementedChatServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedChatServer", reflect.TypeOf((*MockChatServer)(nil).mustEmbedUnimplementedChatServer))
}

// MockUnsafeChatServer is a mock of UnsafeChatServer interface.
type MockUnsafeChatServer struct {
	ctrl     *gomock.Controller
	recorder *MockUnsafeChatServerMockRecorder
}

// MockUnsafeChatServerMockRecorder is the mock recorder for MockUnsafeChatServer.
type MockUnsafeChatServerMockRecorder struct {
	mock *MockUnsafeChatServer
}

// NewMockUnsafeChatServer creates a new mock instance.
func NewMockUnsafeChatServer(ctrl *gomock.Controller) *MockUnsafeChatServer {
	mock := &MockUnsafeChatServer{ctrl: ctrl}
	mock.recorder = &MockUnsafeChatServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUnsafeChatServer) EXPECT() *MockUnsafeChatServerMockRecorder {
	return m.recorder
}

// mustEmbedUnimplementedChatServer mocks base method.
func (m *MockUnsafeChatServer) mustEmbedUnimplementedChatServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedChatServer")
}

// mustEmbedUnimplementedChatServer indicates an expected call of mustEmbedUnimplementedChatServer.
func (mr *MockUnsafeChatServerMockRecorder) mustEmbedUnimplementedChatServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedChatServer", reflect.TypeOf((*MockUnsafeChatServer)(nil).mustEmbedUnimplementedChatServer))
}
