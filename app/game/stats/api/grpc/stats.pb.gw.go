...
var (
	pattern_Stats_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"game", "stats", "user", "uid", "stats_name", "version"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Stats_Get_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"game", "stats", "user", "uid", "stats_name", "version", "range"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Stats_GetAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3}, []string{"game", "stats", "stats_name", "version"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Stats_GetAll_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"game", "stats", "stats_name", "version", "range"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Stats_Gets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"game", "stats", "gets"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Stats_Set_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"game", "stats", "user", "set"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Stats_Sets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"game", "stats", "user", "sets"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Stats_Incr_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"game", "stats", "user", "incr"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Stats_Incrs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"game", "stats", "user", "incrs"}, "", runtime.AssumeColonVerbOpt(true)))
)
