...
var (
	pattern_Skin_GetSkins_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"game", "skin"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Skin_GetInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"game", "skin", "uid"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Skin_SetUsedSkin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"game", "skin", "uid", "used"}, "", runtime.AssumeColonVerbOpt(true)))
)
