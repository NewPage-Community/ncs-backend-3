...
var (
	pattern_Store_BuyItem_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"game", "store", "buy"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Store_HotSaleList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"game", "store", "hotsale"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Store_SaleList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"game", "store", "list"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Store_SaleList_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"game", "store", "list", "uid"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Store_BuyPass_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"game", "store", "buy", "pass"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Store_BuyVIP_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"game", "store", "buy", "vip"}, "", runtime.AssumeColonVerbOpt(true)))
)
