...
var (
	...
	pattern_Server_ChangeMapNotify_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"game", "server", "changemap"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	pattern_Web_Info_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"game", "server", "info", "server_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Web_AllInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"game", "server", "allinfo"}, "", runtime.AssumeColonVerbOpt(true)))
)
