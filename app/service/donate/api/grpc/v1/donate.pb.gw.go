...
var (
	filter_Donate_GetDonateList_2 = &utilities.DoubleArray{Encoding: map[string]int{"start_time": 0, "end_time": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
func request_Donate_GetDonateList_2(ctx context.Context, marshaler runtime.Marshaler, client DonateClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Donate_GetDonateList_2); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
