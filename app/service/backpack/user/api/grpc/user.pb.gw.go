...
var (
	pattern_User_GetItems_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"backpack", "user", "uid"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_User_AddItems_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"backpack", "user", "additem"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_User_HaveItem_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"backpack", "user", "have", "uid", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_User_AddAllItems_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"backpack", "user", "allitems"}, "", runtime.AssumeColonVerbOpt(true)))
)
