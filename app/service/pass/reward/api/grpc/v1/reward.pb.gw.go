...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterRewardHandlerFromEndpoint instead.
func RegisterRewardHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RewardServer) error {
	...
	mux.Handle("GET", pattern_Reward_GetRewards_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ncs.service.pass.reward.v1.Reward/GetRewards", runtime.WithHTTPPathPattern("/pass/reward"))
		if err != nil {
	...
	mux.Handle("GET", pattern_Reward_GetRewards_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ncs.service.pass.reward.v1.Reward/GetRewards", runtime.WithHTTPPathPattern("/pass/reward/level/{level}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Reward_GetRewards_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ncs.service.pass.reward.v1.Reward/GetRewards", runtime.WithHTTPPathPattern("/pass/reward/level/{level}/{min}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterRewardHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RewardClient) error {
	...
	mux.Handle("GET", pattern_Reward_GetRewards_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ncs.service.pass.reward.v1.Reward/GetRewards", runtime.WithHTTPPathPattern("/pass/reward"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Reward_GetRewards_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ncs.service.pass.reward.v1.Reward/GetRewards", runtime.WithHTTPPathPattern("/pass/reward/level/{level}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Reward_GetRewards_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ncs.service.pass.reward.v1.Reward/GetRewards", runtime.WithHTTPPathPattern("/pass/reward/level/{level}/{min}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
