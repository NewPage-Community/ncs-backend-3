...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterTitleHandlerFromEndpoint instead.
func RegisterTitleHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TitleServer) error {
	...
	mux.Handle("GET", pattern_Title_GetTitle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ncs.service.user.title.v1.Title/GetTitle", runtime.WithHTTPPathPattern("/user/title/{uid}"))
		if err != nil {
	...
	mux.Handle("PUT", pattern_Title_SetTitle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ncs.service.user.title.v1.Title/SetTitle", runtime.WithHTTPPathPattern("/user/title/{info.uid}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterTitleHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TitleClient) error {
	...
	mux.Handle("GET", pattern_Title_GetTitle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ncs.service.user.title.v1.Title/GetTitle", runtime.WithHTTPPathPattern("/user/title/{uid}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_Title_SetTitle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ncs.service.user.title.v1.Title/SetTitle", runtime.WithHTTPPathPattern("/user/title/{info.uid}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Title_GetTitle_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"user", "title", "uid"}, ""))

	pattern_Title_SetTitle_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"user", "title", "info.uid"}, ""))
)
