...
http_archive(
    ...
    strip_prefix = "",
    urls = [
        "http://nexus3.nexus3:8081/repository/github/bazelbuild/platforms/releases/download/0.0.4/platforms-0.0.4.tar.gz",
        "https://nexus.new-page.xyz/repository/github/bazelbuild/platforms/releases/download/0.0.4/platforms-0.0.4.tar.gz",
