...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:Fw+ixAJPmKhCLBqDwHlTDqxUxp0xjEwXczEpt1B6r7k=",
        version = "v2.15.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Inlf0YXbgehxVjMPmCGv86iMCKMGPPrPSHtBF5yRHwA=",
        version = "v3.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:J86tSWd3Y7nKjwT/43xZBvpi04keQWx8gNC2YkdJhZI=",
        version = "v4.11.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_lonelyevil_khl",
        importpath = "github.com/lonelyevil/khl",
        sum = "h1:X7BYU4w9rPxSdtjt291+CHjFkkqeeVh/RiZ0BAn+YcE=",
        version = "v0.0.14",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_miremid_amy",
        importpath = "github.com/miRemid/amy",
        sum = "h1:mfgW/Ch+Bey2jrzgZZLOOJUSXkfxs4zI0oetNUZUkx4=",
        version = "v0.1.3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_wechatpay_apiv3_wechatpay_go",
        importpath = "github.com/wechatpay-apiv3/wechatpay-go",
        sum = "h1:vb0ILuwFFsc9CZZ3Ue4feaKzfMxc5tEdb3x/QBLC4U0=",
        version = "v0.2.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ChZ5VfWGB23qEr1kZosidvG9CF9HIczwoxLhBS7Ebs4=",
        version = "v1.0.2",
    )
    go_repository(
        name = "io_gorm_driver_mysql",
        importpath = "gorm.io/driver/mysql",
        sum = "h1:OofcyE2lga734MxwcCW9uB4mWNXMr50uaGRVwQL2B0M=",
        version = "v1.1.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:P7Dm/BKqsrOjyhRSnLXvG2g1W/eJUgxdrdBwgJw3tEg=",
        version = "v1.0.9",
    )
    go_repository(
        name = "io_gorm_gorm",
        importpath = "gorm.io/gorm",
        sum = "h1:gAyaDoPw0lCyrSFWhBlahbUA1U4P5RViC1uIqoB+1Rk=",
        version = "v1.21.15",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:eDd+TJqbgfXruGQ5sJRU7tEtp/58OAx4+Ayjxg4SM+4=",
        version = "v0.0.0-20210924151903-3ad01bbaa167",
    )
    go_repository(
